...
class MetricOptions:
    def __init__(self, 
        ...
        self.editing_fn             = editing_fn
        self.G                      = G
        self.G_kwargs               = dnnlib.EasyDict(G_kwargs)
        self.dataset_kwargs         = dnnlib.EasyDict(dataset_kwargs)
        self.test_dataset_kwargs    = dnnlib.EasyDict(test_dataset_kwargs)
        self.im64_subg_dir          = im64_subg_dir
        ...
        self.cache                  = cache
        self.im64_visualize_dir     = im64_visualize_dir
