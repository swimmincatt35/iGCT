...
#SBATCH --gres=gpu:4
#SBATCH --time=6:00:00
#SBATCH --job-name=eval_edm_c10
#SBATCH --output=eval_edm_c10_%j.out
#SBATCH --error=eval_edm_c10_%j.err
...
srun --nodes=1 --ntasks-per-node=1 \
    ...
    --desc eval_guided_edm_c10 \
    --batch=64 --precond=edm --arch=ncsnpp \
